...
std::uniform_int_distribution<int> distributionnote(0,2);
...
int MelodyGenerator::getNote()
{
  ...
  if (this->randOption == 0) //stapje omlaag
  {
  ...
  else if (this->randOption == 1) //zelfde noot
  {

  }
  else if (this->randOption == 2) //stapje omhoog
  {
